      ...
      <div className="space-y-6">
        ...
        <div className="rounded-xl border border-yellow-300 bg-yellow-50 p-6 shadow-sm">
          ...
          <p className="text-sm text-slate-500">
            ...
            <code className="rounded bg-yellow-200 px-1 py-0.5 text-xs">undefined</code> &mdash;
            ...
            and clear your cookies in Dev Tools &rarr; Application &rarr; Storage &rarr; Clear Site Data.
          </p>
        </div>
    ...
    <div className="space-y-6">
      ...
      {loadingData && libraries.length === 0 ? (
        ...
        <div className="space-y-4">
          {libraries.map((lib) => (
            <div key={lib.id} className="flex items-center justify-between rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md cursor-pointer">
