...
export default function EditBookPage() {
  ...
  async function loadAll(isbn: string) {
    ...
    const al = book.authories; if (Array.isArray(al)) setAuthors(al.join(', '));
